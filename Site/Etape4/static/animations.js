...
function btnConfirm_Click() {
    ...
    $("#mainProgessText").fadeOut("slow", function() {
        ...
        var btnConfirmBeacon = $("#mainOptionExample").clone();
        btnConfirmBeacon.attr("id", "btnConfirmBeacon");
        btnConfirmBeacon.val("Confirm Beacons");
        btnConfirmBeacon.appendTo(".mainController .mainOptions");
        btnConfirmBeacon.css("display", "none");
        btnConfirmBeacon.click(btnConfirmBeacon_Click);
...
function btnSetFirstBeacon_Click() {
    ...
    if (btnBeacon.val() == "Set First Beacon") {
        if (stateAnimation == 0) {
            ...
            elemBeacon.appendTo(".mapBody .imgMap .beacondAndNodes");
...
$("#mapBeaconControl").mousedown(function(e) {
    ...
    if ($("#elemBeacon1").length != 0 && $("#elemBeacon2").length != 0) {
        $("#btnConfirmBeacon").fadeIn("slow");
    }
...
function btnConfirmBeacon_Click() {
